...
import net.minecraft.server.v1_6_R2.IAsyncChunkSaver;
import net.minecraft.server.v1_6_R2.IChunkLoader;
import net.minecraft.server.v1_6_R2.IDataManager;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        public Chunk a(net.minecraft.server.v1_6_R2.World world, int i, int j) {
        ...
        public void a(net.minecraft.server.v1_6_R2.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        public void b(net.minecraft.server.v1_6_R2.World world, Chunk chunk) {
