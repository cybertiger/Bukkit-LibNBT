 ...
 */
package org.cyberiantiger.minecraft.unsafe.v1_7_R2;
...
import net.minecraft.server.v1_7_R2.IAsyncChunkSaver;
import net.minecraft.server.v1_7_R2.IChunkLoader;
import net.minecraft.server.v1_7_R2.IDataManager;
import net.minecraft.server.v1_7_R2.IWorldAccess;
import net.minecraft.server.v1_7_R2.MethodProfiler;
...
import net.minecraft.server.v1_7_R2.WorldProviderHell;
import net.minecraft.server.v1_7_R2.WorldProviderTheEnd;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public org.bukkit.World createInstance(final Plugin plugin, String instanceName, World.Environment env, Difficulty difficulty, File source, File destination) {
        ...
        WorldServer instanceWorld = new WorldServer(console, dataManager, instanceName, dimension, null, console.methodProfiler, env, generator);
        ...
        instanceWorld.difficulty = EnumDifficulty.values()[difficulty.ordinal()];
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        @Override
        public Chunk a(net.minecraft.server.v1_7_R2.World world, int i, int j) {
        ...
        @Override
        public void a(net.minecraft.server.v1_7_R2.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        @Override
        public void b(net.minecraft.server.v1_7_R2.World world, Chunk chunk) {
