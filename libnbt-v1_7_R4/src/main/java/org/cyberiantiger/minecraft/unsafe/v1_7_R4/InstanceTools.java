 ...
 */
package org.cyberiantiger.minecraft.unsafe.v1_7_R4;
...
import net.minecraft.server.v1_7_R4.IAsyncChunkSaver;
import net.minecraft.server.v1_7_R4.IChunkLoader;
import net.minecraft.server.v1_7_R4.IDataManager;
...
import net.minecraft.server.v1_7_R4.WorldProviderHell;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        @Override
        public Chunk a(net.minecraft.server.v1_7_R4.World world, int i, int j) {
        ...
        @Override
        public void a(net.minecraft.server.v1_7_R4.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        @Override
        public void b(net.minecraft.server.v1_7_R4.World world, Chunk chunk) {
