...
import net.minecraft.server.v1_5_R1.IAsyncChunkSaver;
import net.minecraft.server.v1_5_R1.IChunkLoader;
import net.minecraft.server.v1_5_R1.IDataManager;
import net.minecraft.server.v1_5_R1.IWorldAccess;
import net.minecraft.server.v1_5_R1.MethodProfiler;
...
import net.minecraft.server.v1_5_R1.WorldManager;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        public Chunk a(net.minecraft.server.v1_5_R1.World world, int i, int j) {
        ...
        public void a(net.minecraft.server.v1_5_R1.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        public void b(net.minecraft.server.v1_5_R1.World world, Chunk chunk) {
