...
import net.minecraft.server.v1_7_R1.ChunkRegionLoader;
import net.minecraft.server.v1_7_R1.EntityTracker;
import net.minecraft.server.v1_7_R1.EnumDifficulty;
import net.minecraft.server.v1_7_R1.IAsyncChunkSaver;
import net.minecraft.server.v1_7_R1.IChunkLoader;
import net.minecraft.server.v1_7_R1.IDataManager;
import net.minecraft.server.v1_7_R1.IWorldAccess;
import net.minecraft.server.v1_7_R1.MethodProfiler;
...
import net.minecraft.server.v1_7_R1.WorldProviderTheEnd;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        @Override
        public Chunk a(net.minecraft.server.v1_7_R1.World world, int i, int j) {
        ...
        @Override
        public void a(net.minecraft.server.v1_7_R1.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        @Override
        public void b(net.minecraft.server.v1_7_R1.World world, Chunk chunk) {
