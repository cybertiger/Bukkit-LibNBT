...
import net.minecraft.server.v1_5_R2.IAsyncChunkSaver;
import net.minecraft.server.v1_5_R2.IChunkLoader;
import net.minecraft.server.v1_5_R2.IDataManager;
import net.minecraft.server.v1_5_R2.IWorldAccess;
import net.minecraft.server.v1_5_R2.MethodProfiler;
...
import net.minecraft.server.v1_5_R2.ServerNBTManager;
import net.minecraft.server.v1_5_R2.WorldProviderHell;
import net.minecraft.server.v1_5_R2.WorldProviderTheEnd;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    private static class InstanceDataManager extends ServerNBTManager {
        ...
        public InstanceDataManager(Plugin instances, String world, File loadDataFolder, File saveDataFolder) {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        public Chunk a(net.minecraft.server.v1_5_R2.World world, int i, int j) {
        ...
        public void a(net.minecraft.server.v1_5_R2.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        public void b(net.minecraft.server.v1_5_R2.World world, Chunk chunk) {
