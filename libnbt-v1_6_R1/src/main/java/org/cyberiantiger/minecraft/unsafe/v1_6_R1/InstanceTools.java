...
import net.minecraft.server.v1_6_R1.ChunkRegionLoader;
import net.minecraft.server.v1_6_R1.EntityTracker;
import net.minecraft.server.v1_6_R1.IAsyncChunkSaver;
import net.minecraft.server.v1_6_R1.IChunkLoader;
import net.minecraft.server.v1_6_R1.IDataManager;
import net.minecraft.server.v1_6_R1.IWorldAccess;
import net.minecraft.server.v1_6_R1.MethodProfiler;
import net.minecraft.server.v1_6_R1.MinecraftServer;
import net.minecraft.server.v1_6_R1.NBTTagCompound;
import net.minecraft.server.v1_6_R1.WorldData;
import net.minecraft.server.v1_6_R1.WorldManager;
...
import net.minecraft.server.v1_6_R1.RegionFileCache;
import net.minecraft.server.v1_6_R1.ServerNBTManager;
import net.minecraft.server.v1_6_R1.WorldProviderHell;
import net.minecraft.server.v1_6_R1.WorldProviderTheEnd;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        public Chunk a(net.minecraft.server.v1_6_R1.World world, int i, int j) {
        ...
        public void a(net.minecraft.server.v1_6_R1.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        public void b(net.minecraft.server.v1_6_R1.World world, Chunk chunk) {
