 ...
 */
package org.cyberiantiger.minecraft.unsafe.v1_8_R1;
...
import net.minecraft.server.v1_8_R1.IAsyncChunkSaver;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        @Override
        public Chunk a(net.minecraft.server.v1_8_R1.World world, int i, int j) {
        ...
        @Override
        public void a(net.minecraft.server.v1_8_R1.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        @Override
        public void b(net.minecraft.server.v1_8_R1.World world, Chunk chunk) {
