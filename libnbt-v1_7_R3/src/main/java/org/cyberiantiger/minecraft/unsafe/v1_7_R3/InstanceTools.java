...
import net.minecraft.server.v1_7_R3.IAsyncChunkSaver;
...
import net.minecraft.server.v1_7_R3.WorldData;
...
import net.minecraft.server.v1_7_R3.WorldProviderHell;
import net.minecraft.server.v1_7_R3.WorldProviderTheEnd;
...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        @Override
        public void a(net.minecraft.server.v1_7_R3.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        @Override
        public void b(net.minecraft.server.v1_7_R3.World world, Chunk chunk) {
