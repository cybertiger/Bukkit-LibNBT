...
import net.minecraft.server.v1_9_R1.IAsyncChunkSaver;
...
public final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
    ...
    @Override
    public Chunk a(net.minecraft.server.v1_9_R1.World world, int i, int j) throws IOException {
    ...
    @Override
    public void a(net.minecraft.server.v1_9_R1.World world, Chunk chunk) throws IOException, ExceptionWorldConflict {
        saveLoader.a(world, chunk);
    }

    @Override
    public void b(net.minecraft.server.v1_9_R1.World world, Chunk chunk) throws IOException {
