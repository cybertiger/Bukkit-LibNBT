...
public final class InstanceTools extends AbstractInstanceTools {
    ...
    public static final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
        ...
        public Chunk a(net.minecraft.server.v1_5_R3.World world, int i, int j) {
        ...
        public void a(net.minecraft.server.v1_5_R3.World world, Chunk chunk) {
            saveLoader.a(world, chunk);
        }

        public void b(net.minecraft.server.v1_5_R3.World world, Chunk chunk) {
